...
inline std::string* LoginRequest::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:example.LoginRequest.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void LoginRequest::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:example.LoginRequest.name)
}
...
inline std::string* LoginRequest::unsafe_arena_release_pwd() {
  // @@protoc_insertion_point(field_unsafe_arena_release:example.LoginRequest.pwd)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void LoginRequest::unsafe_arena_set_allocated_pwd(
  ...
  pwd_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      pwd, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:example.LoginRequest.pwd)
}
